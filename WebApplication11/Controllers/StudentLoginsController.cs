...
namespace WebApplication11.Controllers
{
    public class StudentLoginsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "RollNo,username,EmailId")] StudentLogin studentLogin)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "RollNo,username,EmailId")] StudentLogin studentLogin)
        {
            if (ModelState.IsValid)
            {
